...
namespace LitMotion
{
    ...
    public static class MotionHandleExtensions
    {
        ...
        public static ValueTask ToValueTask(this MotionHandle handle, CancellationToken cancellationToken = default)
        {
            ...
            var source = ValueTaskMotionConfiguredSource.Create(handle, MotionCanceledBehavior.Cancel, true, cancellationToken, out var token);
        ...
        /// <param name="cancellationToken">CancellationToken</param>
        /// <returns></returns>
        public static ValueTask ToValueTask(this MotionHandle handle, MotionCanceledBehavior cancelBehavior, CancellationToken cancellationToken = default)
        {
            if (!handle.IsActive()) return default;
        ...
        /// <param name="cancellationToken">CancellationToken</param>
        /// <returns></returns>
        public static ValueTask ToValueTask(this MotionHandle handle, MotionCanceledBehavior cancelBehavior, bool cancelAwaitOnMotionCanceled, CancellationToken cancellationToken = default)
        {
            if (!handle.IsActive()) return default;
        ...
        public static Awaitable ToAwaitable(this MotionHandle handle, CancellationToken cancellationToken = default)
        {
            ...
            return AwaitableMotionConfiguredSource.Create(handle, MotionCanceledBehavior.Cancel, true, cancellationToken).Awaitable;
        }
        ...
        /// <param name="cancellationToken">CancellationToken</param>
        /// <returns></returns>
        public static Awaitable ToAwaitable(this MotionHandle handle, MotionCanceledBehavior cancelBehavior, CancellationToken cancellationToken = default)
        {
            if (!handle.IsActive()) return AwaitableMotionConfiguredSource.CompletedSource.Awaitable;
        ...
        /// <param name="cancellationToken">CancellationToken</param>
        /// <returns></returns>
        public static Awaitable ToAwaitable(this MotionHandle handle, MotionCanceledBehavior cancelBehavior, bool cancelAwaitOnMotionCanceled, CancellationToken cancellationToken = default)
        {
            if (!handle.IsActive()) return AwaitableMotionConfiguredSource.CompletedSource.Awaitable;
